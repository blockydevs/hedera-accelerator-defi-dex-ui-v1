export const Routes = {
  ...
  DAOKairosDetails: "kairos-settings/details",
  DAORiskParamsDetails: "kairos-settings/set-risk-params",
  DAOAddTradingPairDetails: "kairos-settings/add-trading-pair",
